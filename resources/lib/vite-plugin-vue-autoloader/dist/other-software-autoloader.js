...
import l, { basename as O, parse as D, resolve as d } from "node:path";
function T(t, e = [".vue"], n = []) {
  return p.existsSync(t) && p.readdirSync(t).forEach((a) => {
    const r = l.join(t, a);
    p.statSync(r).isDirectory() ? n = T(r, e, n) : e.forEach((u) => {
...
function m(t, e, n = void 0) {
  ...
  return Array.isArray(e) && (e = Object.fromEntries(e.map((r) => [r, void 0]))), typeof e == "string" && (e = { [e]: void 0 }), Object.entries(e).forEach(([r, s]) => {
    s && w(d(t.root, s), a, o, n), w(d(t.root, r), a, void 0, n);
  }), { components: a, vendors: o };
}
function w(t, e, n = void 0, o = void 0) {
  T(t).forEach((a) => {
...
function y(t, e, n = !0) {
  ...
  let [a, r] = o, s = m(t, e.components);
  return r && (v(t, e, r, s.vendors), E(t, r, s.vendors)), v(t, e, a, s.components), E(t, a, s.components), n ? x(s.components) : null;
}
function R(t) {
  let e = [];
...
function A(t, e, n = !0) {
  ...
  if (!o)
    throw new Error("Unknown target for output files!");
  let [a, r] = o;
  const s = m(t, e.views, e.namespace);
  return r && (S(t, e, r), g(t, r, s.vendors)), S(t, e, a), g(t, a, s.components), n ? R(s.components) : null;
}
let f = /* @__PURE__ */ new Map();
function V(t, e) {
  let n = m(t, e.views, e.namespace), o = e.namespace || "default", a = /* @__PURE__ */ new Set();
  f.set(o, a), n.components.forEach((r) => {
    a.add(c.normalize(r.path));
  }), n.vendors.forEach((r) => {
    a.add(c.normalize(r.path));
  });
}
...
function b(t, e, n, o) {
  f.has(e.namespace || "default") || V(t, e);
  const a = c.normalize(o);
  if (!o.endsWith(".vue") || !f.get(e.namespace || "default").has(a))
...
function N(t) {
  ...
  return {
    ...
    load(o) {
      if (o === "\0@" + t.namespace + "/components") return y(e, t);
