...
function A(t, e, n = void 0) {
  ...
  return Array.isArray(e) && (e = Object.fromEntries(e.map((o) => [o, void 0]))), typeof e == "string" && (e = { [e]: void 0 }), Object.entries(e).forEach(([o, s]) => {
    s && d(h(t.root, s), p, r, n), d(h(t.root, o), p, void 0, n);
  }), { components: p, vendors: r };
}
function d(t, e, n = void 0, r = void 0) {
  S(t).forEach((p) => {
    let o = V(p, r), s = $(t, p, r), u = I(t, p, r);
...
function v(t, e, n = !0) {
  ...
  return o && (f(t, o, s.vendors), m(t, o, s.vendors)), f(t, p, s.components), m(t, p, s.components), n ? O(s.components) : null;
}
function j(t) {
  let e = [];
