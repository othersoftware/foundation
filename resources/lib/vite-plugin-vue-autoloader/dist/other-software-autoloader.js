...
import u, { basename as A, parse as O, resolve as c } from "node:path";
...
function h(t, e, r) {
  ...
  o.push("// THIS FILE IS AUTOGENERATED!"), o.push("// DO NOT EDIT!"), o.push(""), o.push("declare module '@app/components' {"), o.push("  import { Plugin } from 'vue';"), o.push("  export function createOtherSoftwareAutoloader(): Plugin;"), o.push(""), r.forEach((p) => o.push(`  export { default as ${p.global} } from '${a(u.relative(n, p.path))}';`)), o.push("}"), o.push(""), i.writeFileSync(s, o.join(`
`));
}
function f(t, e, r) {
  let n = u.resolve(t.root, e), s = u.resolve(n, "vue.d.ts"), o = [];
  o.push("// THIS FILE IS AUTOGENERATED!"), o.push("// DO NOT EDIT!"), o.push(""), o.push("declare module '@vue/runtime-core' {"), o.push("  export interface GlobalComponents {"), r.forEach((p) => o.push(`    ${p.global}: typeof import('${a(u.relative(n, p.path))}')['default'],`)), o.push("  }"), o.push("}"), o.push(""), o.push("export {}"), o.push(""), i.writeFileSync(s, o.join(`
`));
}
...
function $(t, e) {
  return e = a(e), t = a(t), e.replace(t, "").replace(/^\//, "").replace(".vue", "").split("/").map(D).join(".");
}
function I(t, e) {
  return e = a(e), t = a(t), e.replace(t, "").replace(/^\//, "").replace(".vue", "").split("/").map(g).join("");
}
function V(t) {
  t = a(t);
  let e = A(t), r = O(e);
...
function m(t, e, r = void 0) {
  S(t).forEach((n) => {
    let s = V(n), o = $(t, n), p = I(t, n);
    n = a(n), r && r.set(p, { global: s, name: p, laravel: o, path: n }), e.set(p, { global: s, name: p, laravel: o, path: n });
  });
}
function d(t, e, r = !0) {
  ...
  let [s, o] = n, p = y(t, e.components);
  return o && (h(t, o, p.vendors), f(t, o, p.vendors)), h(t, s, p.components), f(t, s, p.components), r ? T(p.components) : null;
}
function j(t) {
  let e = [];
...
function E(t, e, r = !0) {
  ...
  let [s, o] = n;
  const p = y(t, e.views);
  return o && (w(t, o), v(t, o, p.vendors)), w(t, s), v(t, s, p.components), r ? j(p.components) : null;
}
function R(t) {
  let e;
  function r(n) {
