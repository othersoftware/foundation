...
namespace OtherSoftware\Translation\Traits;
...
trait Relationship
{
    ...
    public function getTranslationModelNameDefault(): string
    {
        ...
        return $modelName . config('translations.translation_suffix', 'Translation');
    }
    ...
    {
        return config('translations.translation_model_namespace');
    }
